...
if selection == 'Home':
        ...
        st.markdown('- *Demised To Shield* by Ghostrifter Official | https://soundcloud.com/ghostrifter-official.<br>Creative Commons CC BY-SA 3.0 https://creativecommons.org/licenses/by-sa/3.0/')
