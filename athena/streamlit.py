...
if selection == 'Home':
        ...
        st.markdown("""More functionalities are already in development and soon will be available in the application. If you are interested in contributing to this project, check the **Contribute** page for more information. """)
        ...
        st.markdown('🚧 This module is under construction, so you may find new paintings in the future.')
